...
API_ID = int(environ.get('API_ID', '23210282'))
API_HASH = environ.get('API_HASH', '1a0b7164d3b6a9442e3336dfd1044a1e')
BOT_TOKEN = environ.get('BOT_TOKEN', "6020232865:AAGoSFDrBrvlYoO2Xzpdal1bOnB1XmbOstw")
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1870321801').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001461528355').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://mrhariom:ptanhiyrr123@cluster0.s2xcfve.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "MdiskSearchBot")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_files')

# Channel Button Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/mdisk_supports')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/linkzmovie')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/mdisk_supports')
...
URL_SHORTNER_WEBSITE_API = environ.get('URL_SHORTNER_WEBSITE_API', 'df527271f6f0366556b11d40c3a4ea568837d6b9')
